export const artists = {
  ...
  artists: [
    ...
    "Alien Fight Club",
    "Äl Jawala",
    "Amoul Bayi ft. Saah Karim & Galas",
    "Analogkäse",
    "ANNÆLIX Band",
    "Anna Erhard",
    "Annika Threechords",
    ...
    "Bierbabes",
    "Big Joanie",
    "Binghi x Astan KA x Exocé Existe",
    "BLOND",
    "Bloody Marys",
    "Bon Enfant",
    ...
    "Cari Cari",
    "Carlo Karacho",
    "Cassette Head Sessions feat. Styleboi_92 and Mysha",
    "Catt",
    "Cava",
    "Chefdenker",
    "CLT DRP",
    ...
    "Cyness",
    "D.$ahin// Allysa Grace // Evín // Sorvina",
    "Dame Area",
    "Danilo Timm",
    "Dead Chic",
    ...
    "Jungstötter",
    "Kara Delik",
    "Kässrin Kelch & Schaltkreismusik",
    "Kayam",
    "Kerala Dust",
    "KIN'GONGOLO KINIATA",
    "Klotzs",
    ...
    "Techno Brass",
    "Tegel Boys",
    "The Bongo Hop feat. Nidia Gongora",
    "The Chap",
    ...
    "Mind Enterprises",
    "Minuit Machine",
    "Minuscule Mayhem (Jantje Club 27)",
    "Mollono.Bass",
    "Mono & Nikitaman",
    "MOONTIDE",
    "Mr. Vast ",
