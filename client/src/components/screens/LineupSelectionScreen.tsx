  ...
  return (
    ...
    >
      ...
      <Typography variant="body1" sx={{ marginTop: 5 }}>
        Find those Spotify artists and songs which are hidden behind forgettable
        names in your Spotify library and in mind crushing festival lineups!
      </Typography>
      ...
      <Button
        ...
        color="inherit"
        variant="outlined"
        onClick={() => navigate(RouteEnum.ARTISTS)}
      >
        Compare lineup with Spotify library
      </Button>
    </Box>
  );
};
