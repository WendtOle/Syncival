...
export const useFetchPlaylists = async () => {
  ...
  useEffect(() => {
    ...
    const something = async () => {
      ...
      const lineupPlaylists = Object.values(lineups).map(({playlistId}) => playlistId)
      const filteredPlaylistInformation = Object.entries(playlistInformation).reduce((acc, [id, playlist]) => {
